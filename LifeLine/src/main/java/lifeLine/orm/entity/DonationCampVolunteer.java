...
@XmlRootElement
@NamedQueries({
	  @NamedQuery(name = "DonationCampVolunteer.findAll", query = "SELECT d FROM DonationCampVolunteer d")
...
public class DonationCampVolunteer implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.donationCampVolunteerPK == null && other.donationCampVolunteerPK != null) || (this.donationCampVolunteerPK != null && !this.donationCampVolunteerPK.equals(other.donationCampVolunteerPK))) {
            return false;
        }
        return true;
    }
