...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DonationCamp.findAll", query = "SELECT d FROM DonationCamp d")
...
public class DonationCamp implements Serializable {
    ...
    public DonationCamp(Integer id, int userID, int campCategoryID, String address, Date startDate, Date endDate, int unit, int unitLeft) {
        this.id = id;
        this.userID = userID;
